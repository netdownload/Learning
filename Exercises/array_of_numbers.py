...
# имеющий такую же длину, что и исходный. Формироваться он должен по следующему принципу.
#
# Под индексом 0 в итоговом списке должна быть сумма чисел исходного списка без числа под индексом 0 в исходном. Под
# индексом 1 в итоговом списке должна быть сумма чисел исходного списка без числа под индексом 1 в исходном. И так
# далее.
#
